...
import www.pide.com.ui.view.SendMassageDialog;
import www.pide.com.utils.Constant;
import www.pide.com.utils.JsonUtil;
import www.pide.com.utils.RomUtils;
...
public abstract class BaseActivity extends FragmentActivity{
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    for (EMMessage message: messages) {
                        ...
                        if(!sendBean.getMsgType().equals("5")){
                            new SendMassageDialog(BaseActivity.this, sendBean.getMsg(),sendBean.getMsgType(),sendBean.getRoomNum(),sendBean.getmId(),R.style.DialogTheme0).show();
                        }
                    }
                }
            });
    ...
    protected void setTranslucentStatus_w() {
        // 5.0以上系统状态栏透明
