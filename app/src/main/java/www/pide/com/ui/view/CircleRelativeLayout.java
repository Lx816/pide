...
public class CircleRelativeLayout extends LinearLayout {
    private int color;
    private int[] colors;
    private int alpha;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        color = array.getColor(R.styleable.CircleRelativeLayoutLayout_background_color, getResources().getColor(R.color.colorAccent));
