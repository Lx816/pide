...
import www.pide.com.chart.easeui.easeui.domain.EaseEmojiconGroupEntity;
import www.pide.com.chart.easeui.easeui.model.EaseDefaultEmojiconDatas;
import www.pide.com.chart.easeui.easeui.utils.EaseSmileUtils;
import www.pide.com.chart.easeui.easeui.widget.emojicon.EaseEmojiconMenu;
import www.pide.com.chart.easeui.easeui.widget.emojicon.EaseEmojiconMenuBase;
 ...
 */
public class EaseChatInputMenu1 extends LinearLayout {
    ...
    public EaseChatInputMenu1(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public EaseChatInputMenu1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EaseChatInputMenu1(Context context) {
        super(context);
        init(context, null);
    }
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(chatPrimaryMenu == null){
            chatPrimaryMenu = (EaseChatPrimaryMenu1) layoutInflater.inflate(R.layout.ease_layout_chat_primary_menu1, null);
        }
