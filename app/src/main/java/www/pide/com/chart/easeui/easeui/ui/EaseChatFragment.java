...
import www.pide.com.chart.easeui.easeui.EaseConstant;
import www.pide.com.chart.easeui.easeui.EaseUI;
import www.pide.com.chart.easeui.easeui.domain.EaseEmojicon;
import www.pide.com.chart.easeui.easeui.domain.EaseUser;
import www.pide.com.chart.easeui.easeui.model.EaseAtMessageHelper;
import www.pide.com.chart.easeui.easeui.model.EaseCompat;
import www.pide.com.chart.easeui.easeui.model.EaseDingMessageHelper;
import www.pide.com.chart.easeui.easeui.utils.EaseCommonUtils;
import www.pide.com.chart.easeui.easeui.utils.EaseUserUtils;
import www.pide.com.chart.easeui.easeui.widget.EaseAlertDialog;
import www.pide.com.chart.easeui.easeui.widget.EaseChatExtendMenu;
import www.pide.com.chart.easeui.easeui.widget.EaseChatInputMenu;
import www.pide.com.chart.easeui.easeui.widget.EaseChatMessageList;
import www.pide.com.chart.easeui.easeui.widget.EaseVoiceRecorderView;
import www.pide.com.chart.easeui.easeui.widget.chatrow.EaseCustomChatRowProvider;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    private RelativeLayout volide_l;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatUsername = SharedPreferencesUtil.read(getActivity(), "LtAreaPeople", "CHATROOMID");
    ...
    protected void initView() {
        ...
        volide_l = (RelativeLayout) getView().findViewById(R.id.volide_l);
                ...
                switch (msg.what) {
                    case MSG_TYPING_BEGIN: // Notify typing start
                        ...
                        if (hasMessages(MSG_TYPING_END)) {
                            ...
                            beginMsg.setAttribute("avatar", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "AVATAR"));
                            beginMsg.setAttribute("name", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "NAME"));
                            beginMsg.setAttribute("userId", PreferenceManager.getInstance().getCurrentUsername());
                    ...
                    case MSG_TYPING_END:
                        ...
                        endMsg.setAttribute("avatar", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "AVATAR"));
                        endMsg.setAttribute("name", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "NAME"));
                        endMsg.setAttribute("userId", PreferenceManager.getInstance().getCurrentUsername());
...
//        }else{
 ...
 //       }
    ...
    protected void sendMessage(EMMessage message){
        ...
        message.setAttribute("avatar", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "AVATAR"));
        message.setAttribute("name", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "NAME"));
        message.setAttribute("userId", SharedPreferencesUtil.read(getActivity(),"LtAreaPeople", "USERID"));
        message.setMessageStatusCallback(messageStatusCallback);
