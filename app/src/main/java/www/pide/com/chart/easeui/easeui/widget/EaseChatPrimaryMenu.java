    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        buttonPressToSpeak.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    an_text.setTextColor(Color.parseColor("#0076FF"));
                    buttonPressToSpeak.setBackgroundResource(R.mipmap.send_an);
        ...
        buttonPressToSpeak.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                buttonPressToSpeak.setBackgroundResource(R.mipmap.send_song);
